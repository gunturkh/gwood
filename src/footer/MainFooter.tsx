...
export const Footer = () => {
  return (
    <div>
      <footer className=" flex flex-row flex-wrap p-10 bg-[#1C271D] text-base-content font-['Inter'] gap-40 justify-around">
        ...
        <div className="flex items-start justify-center flex-row gap-4 text-white">
          <div className="inline-flex items-center">
            <ImArrowRight2 style={{ fontSize: 20, marginRight: 10 }} />
            <a
